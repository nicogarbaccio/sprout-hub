...
- Name: auth page loads and displays correct info
- Location: /Users/nicogarbaccio/Development/code/Projects/sprouthub/tests/auth.spec.ts:5:1
...
Call log:
  - navigating to "http://localhost:8080/", waiting until "load"
    ...
    at /Users/nicogarbaccio/Development/code/Projects/sprouthub/tests/auth.spec.ts:7:9
```
