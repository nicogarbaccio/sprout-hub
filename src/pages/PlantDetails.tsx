...
const PlantDetails = () => {
  ...
  const plantsData = {
    "peace-lily": {
      ...
      careLevel: "Easy",
      description:
        "The Peace Lily is an elegant houseplant known for its glossy green leaves and distinctive white flowers. It's perfect for beginners and thrives in lower light conditions.",
    ...
    "monstera-deliciosa": {
      ...
      careLevel: "Medium",
      description:
        "Known for its dramatic split leaves, the Monstera Deliciosa is a stunning tropical plant that makes a bold statement in any room.",
    ...
    "snake-plant": {
      ...
      careLevel: "Easy",
      description:
        "The Snake Plant is virtually indestructible and perfect for beginners. Its upright, sword-like leaves add architectural interest to any space.",
  ...
  const plant = plantKey
    ? plantsData[plantKey as keyof typeof plantsData]
    : null;
