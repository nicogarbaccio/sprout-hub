...
- Name: invalid credentials get rejected
- Location: /Users/nicogarbaccio/Development/code/Projects/sprouthub/tests/auth.spec.ts:32:1
...
Call log:
  - navigating to "http://localhost:8080/", waiting until "load"
    ...
    at /Users/nicogarbaccio/Development/code/Projects/sprouthub/tests/auth.spec.ts:34:9
```
